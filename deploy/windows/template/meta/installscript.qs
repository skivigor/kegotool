...
Component.prototype.createOperations = function()
{
    ...
    if (systemInfo.productType === "windows") {
        component.addOperation("CreateShortcut", "@TargetDir@/KegoTool.exe", "@StartMenuDir@/KegoTool.lnk","iconPath=@TargetDir@/KegoTool.ico");
		component.addOperation("CreateShortcut", "@TargetDir@/KegoTool.exe", "@HomeDir@/Desktop/KegoTool.lnk","iconPath=@TargetDir@/KegoTool.ico");
    }
}
